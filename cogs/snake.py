...
class SnakeGameContainer:
    ...
    def __init__(self, size_x: int = 10, size_y: int = 10):
        ...
        self.empty_field = [
            [self.assets["empty"] for _x in range(self.field_size[0])]
            for _y in range(self.field_size[1])
        ]
        ...
        self.snake_body: list[tuple[int, ...]] = [
        ...
        self.field_size_squared: int = size_x * size_y
    ...
    def move_snake(self, x: int = 0, y: int = 0) -> None:
        ...
        # Win condition
        if self.snake_body_size == self.field_size_squared:
            self.win_game()
            return
