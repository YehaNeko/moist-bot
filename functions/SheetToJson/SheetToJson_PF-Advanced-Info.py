...
def sheet_to_json(filepath="ADVINFOSHEET.txt", print_data: bool = False, output_to_file: bool = True,
                  index_offset: int = 2) -> json:
    ...
    """ Optionals """
    if output_to_file:
        with open("output_advinfosheet.json", "w") as f:
